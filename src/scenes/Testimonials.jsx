...
const Testimonials = () => {
  const testimonialsStyles = `mx-auto relative max-w-[400px] h-[350px] flex flex-col
    justify-end pt-6 mt-48 before:absolute before:top-[-120px] before:-ml-[110px] before:left-1/2`;
  ...
  return (
    <section id="testimonials" className="pt-32 pb-16">
      ...
      <div className="md:flex md:justify-between gap-8">
        ...
        <motion.div
          className={`bg-blue ${testimonialsStyles} before:content-person2`}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
        ...
        <motion.div
          className={`bg-blue ${testimonialsStyles} before:content-person3`}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
